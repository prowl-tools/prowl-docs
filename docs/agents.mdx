...
:::note
The `prowlqa hub` CLI is coming in a future release. In the meantime, browse and download templates directly from the [Prowl QA Community Hub](https://hub.prowlqa.dev).
:::
