...
Hover over an element. Useful for triggering tooltips, dropdown menus, or hover states.
...
| `hover: "Profile"` | `hover: { selector: 'text="Profile"' }` |
| `scrollTo: "Footer"` | `scrollTo: { selector: 'text="Footer"' }` |
