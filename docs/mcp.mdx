...
Point your MCP client at the server. The configuration shape is the same across clients — a `mcpServers` entry with the command, its arguments, and the working directory of the project to test.
